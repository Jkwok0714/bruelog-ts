...
A tool for fake brewers

## Setup

* `npm server-dev` to run server dev with nodemon
* `npm run init-db` to create/update the schema
* `npm run document` to run jsdoc on the server files
